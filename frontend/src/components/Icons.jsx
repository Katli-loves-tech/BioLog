...
//
// NOTE ON MailIcon: this wasn't in the original icon spec, but was
// uploaded alongside the others. It's wired up as the icon for the Email
// field on RegisterEmployee (the one input field the spec didn't assign an
// icon to) - flag if that wasn't the intent.
